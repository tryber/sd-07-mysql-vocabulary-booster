SELECT t3.CustomerName AS "Nome de Contato", t2.ShipperName AS "Empresa que fez o envio", DATE(t1.OrderDate) AS "Data do pedido"
FROM w3schools.orders AS t1
INNER JOIN w3schools.shippers AS t2
INNER JOIN w3schools.customers AS t3
ON t1.ShipperID = t2.ShipperID AND t1.CustomerID = t3.CustomerID
