...
CONCAT(hemp2.FIRST_NAME, ' ', hemp2.LAST_NAME) AS 'Nome completo funcionário 1',
hemp2.SALARY AS 'Salário funcionário 1',
hemp2.PHONE_NUMBER AS 'Telefone funcionário 1'
