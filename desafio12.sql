...
CONCAT(F2.FIRST_NAME, ' ', F2.LAST_NAME) AS 'Nome completo funcionário 1',
F2.SALARY AS 'Salário funcionário 1', 
F2.PHONE_NUMBER AS 'Telefone funcionário 1'
FROM hr.employees AS F1
INNER JOIN  hr.employees AS F2
ON F1.JOB_ID = F2.JOB_ID 
WHERE F1.EMPLOYEE_ID <> F2.EMPLOYEE_ID
