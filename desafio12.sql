SELECT CONCAT(func1.FIRST_NAME, ' ', func1.LAST_NAME) AS 'Nome completo funcionário 1',
...
FROM hr.employees AS func1,  hr.employees AS func2
WHERE func1.JOB_ID = func2.JOB_ID
